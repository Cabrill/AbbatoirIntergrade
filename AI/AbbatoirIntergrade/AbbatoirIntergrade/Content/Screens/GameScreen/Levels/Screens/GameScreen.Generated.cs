...
namespace AbbatoirIntergrade.Screens
{
    public partial class GameScreen : FlatRedBall.Screens.Screen
    {
        ...
        public override void AddToManagers () 
        {
            ...
            TileCollisionRectangleFactory.AddList(TileCollisionRectangleList);
            TileCollisionCircleFactory.Initialize(ContentManagerName);
            TileCollisionCircleFactory.AddList(TileCollisionCircleList);
        ...
        public override void Destroy () 
        {
            ...
            TileCollisionRectangleFactory.Destroy();
            TileCollisionCircleFactory.Destroy();
