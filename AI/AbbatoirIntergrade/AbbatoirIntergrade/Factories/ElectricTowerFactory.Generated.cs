...
namespace AbbatoirIntergrade.Factories
{
    public class ElectricTowerFactory : IEntityFactory
    {
        ...
        public static ElectricTower CreateNew (Layer layer, float x = 0, float y = 0) 
        {
            ...
            {
                throw new System.Exception("You must first initialize the factory to use it. You can either add PositionedObjectList of type ElectricTower (the most common solution) or call Initialize in custom code");
            }
            ElectricTower instance = null;
            instance = new ElectricTower(mContentManagerName, false);
