...
namespace AbbatoirIntergrade.Factories
{
    public class Rabbit3EnemyFactory : IEntityFactory
    {
        ...
        public static Rabbit3Enemy CreateNew (Layer layer, float x = 0, float y = 0) 
        {
            ...
            {
                throw new System.Exception("You must first initialize the factory to use it. You can either add PositionedObjectList of type Rabbit3Enemy (the most common solution) or call Initialize in custom code");
            }
