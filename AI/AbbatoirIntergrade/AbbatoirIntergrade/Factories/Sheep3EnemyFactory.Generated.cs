...
namespace AbbatoirIntergrade.Factories
{
    public class Sheep3EnemyFactory : IEntityFactory
    {
        ...
        public static Sheep3Enemy CreateNew (Layer layer, float x = 0, float y = 0) 
        {
            ...
            {
                throw new System.Exception("You must first initialize the factory for this type because it is pooled. You can either add PositionedObjectList of type Sheep3Enemy (the most common solution) or call Initialize in custom code");
            }
