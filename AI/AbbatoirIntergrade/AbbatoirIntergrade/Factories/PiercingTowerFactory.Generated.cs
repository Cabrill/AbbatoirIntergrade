...
{
    public class PiercingTowerFactory : IEntityFactory
    {
        public static FlatRedBall.Math.Axis? SortAxis { get; set;}
        public static PiercingTower CreateNew (float x = 0, float y = 0) 
        {
        ...
        public static PiercingTower CreateNew (Layer layer, float x = 0, float y = 0) 
        {
            ...
            {
                throw new System.Exception("You must first initialize the factory to use it. You can either add PositionedObjectList of type PiercingTower (the most common solution) or call Initialize in custom code");
            }
            PiercingTower instance = null;
            instance = new PiercingTower(mContentManagerName, false);
        ...
        public static void ClearListsToAddTo () 
        {
            ...
            static PoolList<PiercingTower> mPool = new PoolList<PiercingTower>();
            public static Action<PiercingTower> EntitySpawned;
            object IEntityFactory.CreateNew () 
            {
                return PiercingTowerFactory.CreateNew();
            }
            object IEntityFactory.CreateNew (Layer layer) 
            {
                return PiercingTowerFactory.CreateNew(layer);
            }
            ...
            {
                PiercingTowerFactory.ClearListsToAddTo();
            }
            static PiercingTowerFactory mSelf;
            public static PiercingTowerFactory Self
            {
                get
                {
                    if (mSelf == null)
                    {
                        mSelf = new PiercingTowerFactory();
                    }
                    return mSelf;
                }
            }
