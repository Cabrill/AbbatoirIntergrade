...
namespace AbbatoirIntergrade.Factories
{
    public class Cow1EnemyFactory : IEntityFactory
    {
        ...
        public static Cow1Enemy CreateNew (Layer layer, float x = 0, float y = 0) 
        {
            ...
            {
                throw new System.Exception("You must first initialize the factory to use it. You can either add PositionedObjectList of type Cow1Enemy (the most common solution) or call Initialize in custom code");
            }
