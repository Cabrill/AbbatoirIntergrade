...
namespace AbbatoirIntergrade.Factories
{
    public class FrostTowerFactory : IEntityFactory
    {
        ...
        public static FrostTower CreateNew (Layer layer, float x = 0, float y = 0) 
        {
            ...
            {
                throw new System.Exception("You must first initialize the factory to use it. You can either add PositionedObjectList of type FrostTower (the most common solution) or call Initialize in custom code");
            }
            FrostTower instance = null;
            instance = new FrostTower(mContentManagerName, false);
