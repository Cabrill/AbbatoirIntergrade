...
namespace AbbatoirIntergrade.Factories
{
    public class Rabbit1EnemyFactory : IEntityFactory
    {
        ...
        public static Rabbit1Enemy CreateNew (Layer layer, float x = 0, float y = 0) 
        {
            ...
            {
                throw new System.Exception("You must first initialize the factory for this type because it is pooled. You can either add PositionedObjectList of type Rabbit1Enemy (the most common solution) or call Initialize in custom code");
            }
