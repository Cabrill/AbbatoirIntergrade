...
namespace AbbatoirIntergrade.Factories
{
    public class Chicken2EnemyFactory : IEntityFactory
    {
        ...
        public static Chicken2Enemy CreateNew (Layer layer, float x = 0, float y = 0) 
        {
            ...
            {
                throw new System.Exception("You must first initialize the factory for this type because it is pooled. You can either add PositionedObjectList of type Chicken2Enemy (the most common solution) or call Initialize in custom code");
            }
