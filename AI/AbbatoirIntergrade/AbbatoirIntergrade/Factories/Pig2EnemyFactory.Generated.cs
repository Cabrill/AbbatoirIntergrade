...
namespace AbbatoirIntergrade.Factories
{
    public class Pig2EnemyFactory : IEntityFactory
    {
        ...
        public static Pig2Enemy CreateNew (Layer layer, float x = 0, float y = 0) 
        {
            ...
            {
                throw new System.Exception("You must first initialize the factory to use it. You can either add PositionedObjectList of type Pig2Enemy (the most common solution) or call Initialize in custom code");
            }
