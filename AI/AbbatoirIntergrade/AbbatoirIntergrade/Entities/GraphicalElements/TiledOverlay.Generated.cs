...
{
    public partial class TiledOverlay : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible
    {
        ...
        public TiledOverlay (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public TiledOverlay (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void Destroy () 
        {
            if (Used)
            {
                Factories.TiledOverlayFactory.MakeUnused(this, false);
            }
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("TiledOverlayStaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/graphicalelements/tiledoverlay/animationchainlistfile.achx", ContentManagerName))
                {
                    registerUnload = true;
                }
                AnimationChainListFile = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/graphicalelements/tiledoverlay/animationchainlistfile.achx", ContentManagerName);
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/tilesets/combinedassets.png", ContentManagerName))
                {
                    registerUnload = true;
                }
    ...
    public static class TiledOverlayExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<TiledOverlay> list, bool value) 
        {
