...
{
    public partial class TileCollisionRectangle : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public float AxisAlignedRectangleInstanceWidth
        {
            get
            {
            ...
            set
            {
                AxisAlignedRectangleInstance.Width = value;
            }
        }
        ...
        public TileCollisionRectangle () 
        	: this(FlatRedBall.Screens.ScreenManager.CurrentScreen.ContentManagerName, true)
        {
        }
        public TileCollisionRectangle (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public TileCollisionRectangle (string contentManagerName, bool addToManagers) 
        	: base()
        {
