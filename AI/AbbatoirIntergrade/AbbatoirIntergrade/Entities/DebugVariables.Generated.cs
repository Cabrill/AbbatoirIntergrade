...
{
    public partial class DebugVariables : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable
    {
        ...
        public DebugVariables (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public DebugVariables (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("DebugVariablesStaticUnload", UnloadStaticContent);
