...
namespace AbbatoirIntergrade.Entities.Projectiles
{
    public partial class FrostProjectile : AbbatoirIntergrade.Entities.BaseEntities.BasePlayerProjectile, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public FrostProjectile (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public FrostProjectile (string contentManagerName, bool addToManagers) 
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.FrostProjectileFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public override void PostInitialize () 
        {
            ...
            base.LightOrShadowSprite.LeftTexturePixel = 964f;
            base.LightOrShadowSprite.RightTexturePixel = 1014f;
            base.LightOrShadowSprite.TopTexturePixel = 1886f;
            base.LightOrShadowSprite.BottomTexturePixel = 1938f;
            ...
            base.LightOrShadowSprite.Alpha = 0.2f;
