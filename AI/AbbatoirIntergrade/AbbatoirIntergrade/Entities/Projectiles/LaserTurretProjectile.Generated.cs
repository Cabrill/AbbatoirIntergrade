...
{
    public partial class LaserTurretProjectile : AbbatoirIntergrade.Entities.BaseEntities.BasePlayerProjectile, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        protected static FlatRedBall.Graphics.Animation.AnimationChainList LaserTurretProjectileAnimationChainListFile;
        protected static Microsoft.Xna.Framework.Audio.SoundEffect Laser_Ground;
        protected static Microsoft.Xna.Framework.Audio.SoundEffect Laser_Hit;
        ...
        public LaserTurretProjectile () 
        	: this(FlatRedBall.Screens.ScreenManager.CurrentScreen.ContentManagerName, true)
        {
        }
        public LaserTurretProjectile (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public LaserTurretProjectile (string contentManagerName, bool addToManagers) 
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.LaserTurretProjectileFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public override void PostInitialize () 
        {
            ...
            base.SpriteInstance.AnimationChains = LaserTurretProjectileAnimationChainListFile;
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("LaserTurretProjectileStaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                LaserTurretProjectileAnimationChainListFile = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/projectiles/laserturretprojectile/laserturretprojectileanimationchainlistfile.achx", ContentManagerName);
                Laser_Ground = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Audio.SoundEffect>(@"content/entities/projectiles/laserturretprojectile/laser_ground", ContentManagerName);
                Laser_Hit = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Audio.SoundEffect>(@"content/entities/projectiles/laserturretprojectile/laser_hit", ContentManagerName);
            }
        ...
        public static new object GetStaticMember (string memberName) 
        {
            switch(memberName)
            {
                case  "LaserTurretProjectileAnimationChainListFile":
                    return LaserTurretProjectileAnimationChainListFile;
                case  "Laser_Ground":
                    return Laser_Ground;
                case  "Laser_Hit":
                    return Laser_Hit;
    ...
    public static class LaserTurretProjectileExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<LaserTurretProjectile> list, bool value) 
        {
