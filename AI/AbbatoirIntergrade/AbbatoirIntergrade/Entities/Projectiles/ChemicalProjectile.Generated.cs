...
namespace AbbatoirIntergrade.Entities.Projectiles
{
    public partial class ChemicalProjectile : AbbatoirIntergrade.Entities.BaseEntities.BasePlayerProjectile, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable
    {
        ...
        public ChemicalProjectile (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public ChemicalProjectile (string contentManagerName, bool addToManagers) 
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.ChemicalProjectileFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("ChemicalProjectileStaticUnload", UnloadStaticContent);
