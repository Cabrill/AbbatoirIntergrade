...
{
    public partial class DarknessOverlay : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Graphics.IVisible
    {
        ...
        public DarknessOverlay (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public DarknessOverlay (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("DarknessOverlayStaticUnload", UnloadStaticContent);
    ...
    public static class DarknessOverlayExtensionMethods
    {
