...
{
    public partial class BasicAlien : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Gui.IClickable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public BasicAlien (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public BasicAlien (string contentManagerName, bool addToManagers) 
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.BasicAlienFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("BasicAlienStaticUnload", UnloadStaticContent);
    ...
    public static class BasicAlienExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<BasicAlien> list, bool value) 
        {
