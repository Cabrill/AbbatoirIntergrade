...
{
    public partial class Pig3Enemy : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Gui.IClickable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public Pig3Enemy (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Pig3Enemy (string contentManagerName, bool addToManagers) 
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.Pig3EnemyFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public override void PostInitialize () 
        {
            ...
            base.SpriteInstance.AnimationChains = Pig3Animations;
            ...
            if (ShadowSprite.Parent == null)
            {
                base.ShadowSprite.Y = -74f;
            }
            else
            {
                base.ShadowSprite.RelativeY = -74f;
            }
            if (ShadowSprite.Parent == null)
            {
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Pig3EnemyStaticUnload", UnloadStaticContent);
    ...
    public static class Pig3EnemyExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<Pig3Enemy> list, bool value) 
        {
