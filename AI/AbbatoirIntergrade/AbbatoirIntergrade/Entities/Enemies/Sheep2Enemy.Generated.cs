...
{
    public partial class Sheep2Enemy : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Gui.IClickable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public Sheep2Enemy (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Sheep2Enemy (string contentManagerName, bool addToManagers) 
        ...
        protected override void InitializeEntity (bool addToManagers) 
        {
            ...
            // Not instantiating for AxisAlignedRectangle AxisAlignedRectangleInstance in Entities\Enemies\Sheep2Enemy because properties on the object prevent it
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.Sheep2EnemyFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public override void PostInitialize () 
        {
            ...
            base.SpriteInstance.AnimationChains = Sheep2Animations;
            ...
            if (ShadowSprite.Parent == null)
            {
                base.ShadowSprite.X = -18f;
            }
            else
            {
                base.ShadowSprite.RelativeX = -18f;
            }
            if (ShadowSprite.Parent == null)
            {
                base.ShadowSprite.Y = -54f;
            }
            else
            {
                base.ShadowSprite.RelativeY = -54f;
            }
            if (ShadowSprite.Parent == null)
            {
            ...
            base.ShadowSprite.Width = 56f;
            base.ShadowSprite.Height = 18f;
            #if FRB_MDX
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Sheep2EnemyStaticUnload", UnloadStaticContent);
    ...
    public static class Sheep2EnemyExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<Sheep2Enemy> list, bool value) 
        {
