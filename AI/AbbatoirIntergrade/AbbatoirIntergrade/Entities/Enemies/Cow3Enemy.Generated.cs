...
{
    public partial class Cow3Enemy : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Gui.IClickable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        protected static FlatRedBall.Graphics.Animation.AnimationChainList Cow3Animations;
        protected static Microsoft.Xna.Framework.Graphics.Texture2D Stage3;
        protected static Microsoft.Xna.Framework.Audio.SoundEffect Cow3Death1;
        ...
        public Cow3Enemy (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Cow3Enemy (string contentManagerName, bool addToManagers) 
        ...
        protected override void InitializeEntity (bool addToManagers) 
        {
            ...
            // Not instantiating for AxisAlignedRectangle AxisAlignedRectangleInstance in Entities\Enemies\Cow3Enemy because properties on the object prevent it
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.Cow3EnemyFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public override void PostInitialize () 
        {
            ...
            base.SpriteInstance.AnimationChains = Cow3Animations;
            ...
            if (ShadowSprite.Parent == null)
            {
                base.ShadowSprite.Y = -164f;
            }
            else
            {
                base.ShadowSprite.RelativeY = -164f;
            }
            if (ShadowSprite.Parent == null)
            {
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Cow3EnemyStaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                Cow3Animations = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/gamescreen/monsters/cow3animations.achx", ContentManagerName);
                ...
                Cow3Death1 = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Audio.SoundEffect>(@"content/entities/enemies/cow3enemy/cow3death1", ContentManagerName);
            }
    ...
    public static class Cow3EnemyExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<Cow3Enemy> list, bool value) 
        {
