...
{
    public partial class SlimeAlien : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable
    {
        ...
        public Entities.Enemies.SlimeAlien.Jump CurrentJumpState
        {
            get
            {
        ...
        public SlimeAlien (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public SlimeAlien (string contentManagerName, bool addToManagers) 
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.SlimeAlienFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public override void PostInitialize () 
        {
            ...
            base.ShadowSprite.Width = 120f;
            base.ShadowSprite.Height = 60f;
            #if FRB_MDX
            ShadowSprite.ColorOperation = Microsoft.DirectX.Direct3D.TextureOperation.Texture;
            #else
            base.ShadowSprite.ColorOperation = FlatRedBall.Graphics.ColorOperation.Texture;
            #endif
            base.ShadowSprite.BlendOperation = FlatRedBall.Graphics.BlendOperation.Regular;
        ...
        public override void AssignCustomVariables (bool callOnContainedElements) 
        {
            ...
            MeleeAttackDamage = 20f;
            SecondsBetweenMeleeAttack = 3f;
            MineralsRewardedWhenKilled = 35;
            DisplayName = "Slime";
            IsMeleeAttacker = true;
            MeleeAttackRadius = 96f;
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("SlimeAlienStaticUnload", UnloadStaticContent);
