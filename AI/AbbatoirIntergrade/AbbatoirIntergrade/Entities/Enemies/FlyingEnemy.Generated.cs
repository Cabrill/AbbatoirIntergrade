...
{
    public partial class FlyingEnemy : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public FlyingEnemy (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public FlyingEnemy (string contentManagerName, bool addToManagers) 
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.FlyingEnemyFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("FlyingEnemyStaticUnload", UnloadStaticContent);
    ...
    public static class FlyingEnemyExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<FlyingEnemy> list, bool value) 
        {
