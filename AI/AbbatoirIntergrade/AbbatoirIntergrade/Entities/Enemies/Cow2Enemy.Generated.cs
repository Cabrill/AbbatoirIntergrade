...
{
    public partial class Cow2Enemy : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Gui.IClickable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public Cow2Enemy (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Cow2Enemy (string contentManagerName, bool addToManagers) 
        ...
        protected override void InitializeEntity (bool addToManagers) 
        {
            ...
            // Not instantiating for Circle CircleInstance in Entities\Enemies\Cow2Enemy because properties on the object prevent it
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.Cow2EnemyFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public override void PostInitialize () 
        {
            ...
            if (ShadowSprite.Parent == null)
            {
                base.ShadowSprite.X = -8f;
            }
            else
            {
                base.ShadowSprite.RelativeX = -8f;
            }
            if (ShadowSprite.Parent == null)
            {
                base.ShadowSprite.Y = -46f;
            }
            else
            {
                base.ShadowSprite.RelativeY = -46f;
            }
            if (ShadowSprite.Parent == null)
            {
            ...
            base.AxisAlignedRectangleInstance.Width = 105f;
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Cow2EnemyStaticUnload", UnloadStaticContent);
    ...
    public static class Cow2EnemyExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<Cow2Enemy> list, bool value) 
        {
