...
{
    public partial class Rabbit2Enemy : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Gui.IClickable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public Rabbit2Enemy (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Rabbit2Enemy (string contentManagerName, bool addToManagers) 
        ...
        public override void AssignCustomVariables (bool callOnContainedElements) 
        {
            ...
            MaximumHealth = 32f;
            Speed = 150f;
            DisplayName = "Abnormal Rabbit";
            IsFlying = false;
            HasLightSource = false;
            IsJumper = false;
            Mass = 0.1f;
            BaseHealth = 80f;
            BasePiercingResist = 0.5f;
            BaseBombardResist = 0.5f;
            BaseChemicalResist = 0.175f;
            BaseFrostResist = 0.8f;
            BaseFireResist = 0.35f;
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Rabbit2EnemyStaticUnload", UnloadStaticContent);
    ...
    public static class Rabbit2EnemyExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<Rabbit2Enemy> list, bool value) 
        {
