...
namespace AbbatoirIntergrade.Entities.Enemies
{
    public partial class Pig1Enemy : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Gui.IClickable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        protected static FlatRedBall.Graphics.Animation.AnimationChainList Pig1Animations;
        protected static Microsoft.Xna.Framework.Graphics.Texture2D Stage1;
        protected static Microsoft.Xna.Framework.Audio.SoundEffect Pig1Death1;
        ...
        public Pig1Enemy (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Pig1Enemy (string contentManagerName, bool addToManagers) 
        ...
        protected override void InitializeEntity (bool addToManagers) 
        {
            ...
            // Not instantiating for Circle CircleInstance in Entities\Enemies\Pig1Enemy because properties on the object prevent it
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.Pig1EnemyFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public override void PostInitialize () 
        {
            ...
            base.SpriteInstance.TextureScale = 0.3f;
            base.SpriteInstance.UseAnimationRelativePosition = true;
            base.SpriteInstance.AnimationChains = Pig1Animations;
            ...
            base.LightSprite.TextureScale = 0.3f;
            ...
            if (ShadowSprite.Parent == null)
            {
                base.ShadowSprite.Y = -26f;
            }
            else
            {
                base.ShadowSprite.RelativeY = -26f;
            }
            if (ShadowSprite.Parent == null)
            {
            ...
            base.ShadowSprite.Width = 52f;
            base.ShadowSprite.Height = 12f;
            #if FRB_MDX
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Pig1EnemyStaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                Pig1Animations = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/gamescreen/monsters/pig1animations.achx", ContentManagerName);
                ...
                Pig1Death1 = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Audio.SoundEffect>(@"content/entities/enemies/pig1enemy/pig1death1", ContentManagerName);
            }
    ...
    public static class Pig1EnemyExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<Pig1Enemy> list, bool value) 
        {
