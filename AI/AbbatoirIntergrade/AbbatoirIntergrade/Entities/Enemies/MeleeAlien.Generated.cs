...
{
    public partial class MeleeAlien : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Gui.IClickable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        protected static Microsoft.Xna.Framework.Audio.SoundEffect alien_melee;
        ...
        public MeleeAlien (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public MeleeAlien (string contentManagerName, bool addToManagers) 
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.MeleeAlienFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public override void PostInitialize () 
        {
            ...
            base.SpriteInstance.RightTexturePixel = 256f;
            base.SpriteInstance.TopTexturePixel = 512f;
            base.SpriteInstance.BottomTexturePixel = 1024f;
            base.SpriteInstance.TextureScale = 0.6f;
            ...
            base.LightSprite.TextureScale = 2.6f;
            #if FRB_MDX
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("MeleeAlienStaticUnload", UnloadStaticContent);
                ...
                alien_melee = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Audio.SoundEffect>(@"content/entities/enemies/basicalien/alien_melee", ContentManagerName);
    ...
    public static class MeleeAlienExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<MeleeAlien> list, bool value) 
        {
