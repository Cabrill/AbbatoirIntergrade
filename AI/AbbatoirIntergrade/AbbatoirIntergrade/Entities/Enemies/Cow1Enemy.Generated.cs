...
{
    public partial class Cow1Enemy : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Gui.IClickable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        protected static FlatRedBall.Graphics.Animation.AnimationChainList Cow1Animations;
        protected static Microsoft.Xna.Framework.Graphics.Texture2D Stage1;
        protected static Microsoft.Xna.Framework.Audio.SoundEffect Cow1Death1;
        ...
        public Cow1Enemy (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Cow1Enemy (string contentManagerName, bool addToManagers) 
        ...
        protected override void InitializeEntity (bool addToManagers) 
        {
            ...
            // Not instantiating for Circle CircleInstance in Entities\Enemies\Cow1Enemy because properties on the object prevent it
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.Cow1EnemyFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public override void PostInitialize () 
        {
            ...
            base.ShadowSprite.Width = 112f;
            base.ShadowSprite.Height = 25f;
            #if FRB_MDX
            ...
            {
                base.AxisAlignedRectangleInstance.Y = 24f;
            }
            else
            {
                base.AxisAlignedRectangleInstance.RelativeY = 24f;
            }
            base.AxisAlignedRectangleInstance.Width = 108f;
            base.AxisAlignedRectangleInstance.Height = 24f;
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Cow1EnemyStaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                Cow1Animations = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/gamescreen/monsters/cow1animations.achx", ContentManagerName);
                ...
                Cow1Death1 = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Audio.SoundEffect>(@"content/entities/enemies/cow1enemy/cow1death1", ContentManagerName);
            }
    ...
    public static class Cow1EnemyExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<Cow1Enemy> list, bool value) 
        {
