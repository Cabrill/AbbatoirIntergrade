...
{
    public partial class Sheep3Enemy : AbbatoirIntergrade.Entities.BaseEntities.BaseEnemy, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Graphics.IVisible, FlatRedBall.Gui.IClickable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public Sheep3Enemy (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Sheep3Enemy (string contentManagerName, bool addToManagers) 
        ...
        protected override void InitializeEntity (bool addToManagers) 
        {
            ...
            // Not instantiating for AxisAlignedRectangle AxisAlignedRectangleInstance in Entities\Enemies\Sheep3Enemy because properties on the object prevent it
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.Sheep3EnemyFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public override void PostInitialize () 
        {
            ...
            base.SpriteInstance.AnimationChains = Sheep3Animations;
            ...
            if (ShadowSprite.Parent == null)
            {
                base.ShadowSprite.Y = -58f;
            }
            else
            {
                base.ShadowSprite.RelativeY = -58f;
            }
            if (ShadowSprite.Parent == null)
            {
            ...
            base.ShadowSprite.Width = 66f;
            base.ShadowSprite.Height = 19f;
            #if FRB_MDX
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Sheep3EnemyStaticUnload", UnloadStaticContent);
    ...
    public static class Sheep3EnemyExtensionMethods
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<Sheep3Enemy> list, bool value) 
        {
