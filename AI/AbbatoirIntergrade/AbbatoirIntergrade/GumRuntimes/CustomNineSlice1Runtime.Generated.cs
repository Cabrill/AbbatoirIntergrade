    ...
    {
        public partial class CustomNineSlice1Runtime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.CustomNineSlice1Runtime.VariableState fromState,AbbatoirIntergrade.GumRuntimes.CustomNineSlice1Runtime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null)
            {
            ...
            public CustomNineSlice1Runtime (bool fullInstantiation = true)
            	: base(false)
            {
                this.HasEvents = true;
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "CustomNineSlice1");
