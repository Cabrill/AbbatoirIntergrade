    ...
    namespace AbbatoirIntergrade.GumRuntimes
    {
        public partial class RadioButtonRuntime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
                ...
                set
                {
                    ...
                    switch(mCurrentRadioButtonCategoryState)
                    {
                        case  RadioButtonCategory.EnabledOn:
                            ...
                            ColoredFrameInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Gray;
                        ...
                        case  RadioButtonCategory.DisabledOn:
                            ColoredFrameInstance.Blue = 255;
                            ColoredFrameInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Black;
                            ColoredFrameInstance.Green = 255;
                            ColoredFrameInstance.Red = 255;
                            SpriteInstance.Visible = true;
                            break;
                        ...
                        case  RadioButtonCategory.HighlightedOn:
                            ColoredFrameInstance.Blue = 255;
                            ColoredFrameInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Yellow;
                            ColoredFrameInstance.Green = 255;
                            ColoredFrameInstance.Red = 255;
                            SpriteInstance.Visible = true;
                            break;
            ...
            public void InterpolateBetween (RadioButtonCategory firstState, RadioButtonCategory secondState, float interpolationValue) 
            {
                ...
                ColoredFrameRuntime.ColorCategory ColoredFrameInstanceCurrentColorCategoryStateFirstValue= ColoredFrameRuntime.ColorCategory.Gray;
                ColoredFrameRuntime.ColorCategory ColoredFrameInstanceCurrentColorCategoryStateSecondValue= ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  RadioButtonCategory.EnabledOn:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Gray;
                    ...
                    case  RadioButtonCategory.DisabledOn:
                        ...
                        ColoredFrameInstanceBlueFirstValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateFirstValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Black;
                        setColoredFrameInstanceGreenFirstValue = true;
                        ColoredFrameInstanceGreenFirstValue = 255;
                        setColoredFrameInstanceRedFirstValue = true;
                        ColoredFrameInstanceRedFirstValue = 255;
                    ...
                    case  RadioButtonCategory.HighlightedOn:
                        ...
                        ColoredFrameInstanceBlueFirstValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateFirstValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Yellow;
                        setColoredFrameInstanceGreenFirstValue = true;
                        ColoredFrameInstanceGreenFirstValue = 255;
                        setColoredFrameInstanceRedFirstValue = true;
                        ColoredFrameInstanceRedFirstValue = 255;
                ...
                switch(secondState)
                {
                    case  RadioButtonCategory.EnabledOn:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Gray;
                    ...
                    case  RadioButtonCategory.DisabledOn:
                        ...
                        ColoredFrameInstanceBlueSecondValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateSecondValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Black;
                        setColoredFrameInstanceGreenSecondValue = true;
                        ColoredFrameInstanceGreenSecondValue = 255;
                        setColoredFrameInstanceRedSecondValue = true;
                        ColoredFrameInstanceRedSecondValue = 255;
                    ...
                    case  RadioButtonCategory.HighlightedOn:
                        ...
                        ColoredFrameInstanceBlueSecondValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateSecondValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Yellow;
                        setColoredFrameInstanceGreenSecondValue = true;
                        ColoredFrameInstanceGreenSecondValue = 255;
                        setColoredFrameInstanceRedSecondValue = true;
                        ColoredFrameInstanceRedSecondValue = 255;
            ...
            private AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime ColoredFrameInstance { get; set; }
            ...
            {
                ColoredFrameInstance = this.GetGraphicalUiElementByName("ColoredFrameInstance") as AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime;
