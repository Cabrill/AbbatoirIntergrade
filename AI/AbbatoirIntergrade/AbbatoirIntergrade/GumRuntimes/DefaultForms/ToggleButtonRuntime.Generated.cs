    ...
    {
        public partial class ToggleButtonRuntime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.ToggleButtonRuntime.VariableState fromState,AbbatoirIntergrade.GumRuntimes.ToggleButtonRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.ToggleButtonRuntime.ToggleCategory fromState,AbbatoirIntergrade.GumRuntimes.ToggleButtonRuntime.ToggleCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private AbbatoirIntergrade.GumRuntimes.NineSliceRuntime NineSliceInstance1 { get; set; }
            ...
            private void AssignReferences () 
            {
                ...
                NineSliceInstance1 = this.GetGraphicalUiElementByName("NineSliceInstance1") as AbbatoirIntergrade.GumRuntimes.NineSliceRuntime;
