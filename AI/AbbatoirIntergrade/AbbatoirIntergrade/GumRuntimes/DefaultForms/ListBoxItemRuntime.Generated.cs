                ...
                set
                {
                    ...
                    switch(mCurrentListBoxItemCategoryState)
                    {
                        case  ListBoxItemCategory.Enabled:
                            BackgroundInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Gray;
                            break;
                        case  ListBoxItemCategory.Highlighted:
                            BackgroundInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Yellow;
                            BackgroundInstance.X = 0f;
                            BackgroundInstance.XOrigin = RenderingLibrary.Graphics.HorizontalAlignment.Center;
                            BackgroundInstance.XUnits = Gum.Converters.GeneralUnitType.PixelsFromMiddle;
                            BackgroundInstance.Y = 0f;
                        ...
                        case  ListBoxItemCategory.Selected:
                            BackgroundInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Green;
                            break;
                    }
                }
            }
            ...
            public void InterpolateBetween (ListBoxItemCategory firstState, ListBoxItemCategory secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  ListBoxItemCategory.Enabled:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Gray;
                        break;
                    case  ListBoxItemCategory.Highlighted:
                        setBackgroundInstanceCurrentColorCategoryStateFirstValue = true;
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Yellow;
                        setBackgroundInstanceXFirstValue = true;
                        BackgroundInstanceXFirstValue = 0f;
                        if (interpolationValue < 1)
                        {
                    ...
                    case  ListBoxItemCategory.Selected:
                        setBackgroundInstanceCurrentColorCategoryStateFirstValue = true;
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Green;
                        break;
                }
                switch(secondState)
                {
                    case  ListBoxItemCategory.Enabled:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Gray;
                        break;
                    case  ListBoxItemCategory.Highlighted:
                        setBackgroundInstanceCurrentColorCategoryStateSecondValue = true;
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Yellow;
                        setBackgroundInstanceXSecondValue = true;
                        BackgroundInstanceXSecondValue = 0f;
                        if (interpolationValue >= 1)
                        {
                    ...
                    case  ListBoxItemCategory.Selected:
                        setBackgroundInstanceCurrentColorCategoryStateSecondValue = true;
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Green;
                        break;
                }
