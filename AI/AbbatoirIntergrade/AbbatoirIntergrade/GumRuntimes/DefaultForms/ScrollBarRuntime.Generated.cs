    ...
    {
        public partial class ScrollBarRuntime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            X = 0f;
                            Y = 0f;
                            BackgroundInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Black;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                ColoredFrameRuntime.ColorCategory BackgroundInstanceCurrentColorCategoryStateFirstValue= ColoredFrameRuntime.ColorCategory.Gray;
                ColoredFrameRuntime.ColorCategory BackgroundInstanceCurrentColorCategoryStateSecondValue= ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Black;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Black;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.ScrollBarRuntime.VariableState fromState,AbbatoirIntergrade.GumRuntimes.ScrollBarRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.ScrollBarRuntime.ScrollBarCategory fromState,AbbatoirIntergrade.GumRuntimes.ScrollBarRuntime.ScrollBarCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime BackgroundInstance { get; set; }
            private AbbatoirIntergrade.GumRuntimes.ButtonRuntime UpButtonInstance { get; set; }
            private AbbatoirIntergrade.GumRuntimes.ButtonRuntime DownButtonInstance { get; set; }
            private AbbatoirIntergrade.GumRuntimes.ScrollBarThumbRuntime ThumbInstance { get; set; }
            private AbbatoirIntergrade.GumRuntimes.SpriteRuntime SpriteInstance1 { get; set; }
            private AbbatoirIntergrade.GumRuntimes.SpriteRuntime SpriteInstance2 { get; set; }
            private AbbatoirIntergrade.GumRuntimes.ContainerRuntime ThumbContainer { get; set; }
            ...
            {
                BackgroundInstance = this.GetGraphicalUiElementByName("BackgroundInstance") as AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime;
                UpButtonInstance = this.GetGraphicalUiElementByName("UpButtonInstance") as AbbatoirIntergrade.GumRuntimes.ButtonRuntime;
                DownButtonInstance = this.GetGraphicalUiElementByName("DownButtonInstance") as AbbatoirIntergrade.GumRuntimes.ButtonRuntime;
                ThumbInstance = this.GetGraphicalUiElementByName("ThumbInstance") as AbbatoirIntergrade.GumRuntimes.ScrollBarThumbRuntime;
                SpriteInstance1 = this.GetGraphicalUiElementByName("SpriteInstance1") as AbbatoirIntergrade.GumRuntimes.SpriteRuntime;
                SpriteInstance2 = this.GetGraphicalUiElementByName("SpriteInstance2") as AbbatoirIntergrade.GumRuntimes.SpriteRuntime;
                ThumbContainer = this.GetGraphicalUiElementByName("ThumbContainer") as AbbatoirIntergrade.GumRuntimes.ContainerRuntime;
