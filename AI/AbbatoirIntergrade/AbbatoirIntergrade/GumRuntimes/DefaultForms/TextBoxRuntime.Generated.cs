    ...
    {
        public partial class TextBoxRuntime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.TextBoxRuntime.VariableState fromState,AbbatoirIntergrade.GumRuntimes.TextBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.TextBoxRuntime.TextBoxCategory fromState,AbbatoirIntergrade.GumRuntimes.TextBoxRuntime.TextBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private AbbatoirIntergrade.GumRuntimes.ColoredRectangleRuntime CaretInstance { get; set; }
            ...
            private void AssignReferences () 
            {
                ...
                CaretInstance = this.GetGraphicalUiElementByName("CaretInstance") as AbbatoirIntergrade.GumRuntimes.ColoredRectangleRuntime;
