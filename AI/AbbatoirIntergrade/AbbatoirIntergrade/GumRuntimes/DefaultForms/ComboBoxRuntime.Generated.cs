    ...
    {
        public partial class ComboBoxRuntime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            NineSliceInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Blue;
                            ...
                            TextInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.TextRuntime.ColorCategory.Gray;
                ...
                set
                {
                    ...
                    switch(mCurrentComboBoxCategoryState)
                    {
                        ...
                        case  ComboBoxCategory.Disabled:
                            NineSliceInstance.Blue = 255;
                            NineSliceInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Black;
                            NineSliceInstance.Green = 255;
                            NineSliceInstance.Red = 255;
                            TextInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.TextRuntime.ColorCategory.Gray;
                            break;
                        case  ComboBoxCategory.Highlighted:
                            NineSliceInstance.Blue = 255;
                            NineSliceInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Yellow;
                            NineSliceInstance.Green = 255;
                            NineSliceInstance.Red = 255;
                            TextInstance.CurrentColorCategoryState = AbbatoirIntergrade.GumRuntimes.TextRuntime.ColorCategory.Black;
                            break;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                ColoredFrameRuntime.ColorCategory NineSliceInstanceCurrentColorCategoryStateFirstValue= ColoredFrameRuntime.ColorCategory.Gray;
                ColoredFrameRuntime.ColorCategory NineSliceInstanceCurrentColorCategoryStateSecondValue= ColoredFrameRuntime.ColorCategory.Gray;
                ...
                TextRuntime.ColorCategory TextInstanceCurrentColorCategoryStateFirstValue= TextRuntime.ColorCategory.Gray;
                TextRuntime.ColorCategory TextInstanceCurrentColorCategoryStateSecondValue= TextRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Blue;
                        ...
                        TextInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.TextRuntime.ColorCategory.Gray;
                        if (interpolationValue < 1)
                        {
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Blue;
                        ...
                        TextInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.TextRuntime.ColorCategory.Gray;
                        if (interpolationValue >= 1)
                        {
                            this.TextInstance.HorizontalAlignment = RenderingLibrary.Graphics.HorizontalAlignment.Left;
                        }
            ...
            public void InterpolateBetween (ComboBoxCategory firstState, ComboBoxCategory secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    ...
                    case  ComboBoxCategory.Disabled:
                        ...
                        NineSliceInstanceBlueFirstValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateFirstValue = true;
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Black;
                        setNineSliceInstanceGreenFirstValue = true;
                        NineSliceInstanceGreenFirstValue = 255;
                        setNineSliceInstanceRedFirstValue = true;
                        NineSliceInstanceRedFirstValue = 255;
                    ...
                    case  ComboBoxCategory.Highlighted:
                        ...
                        NineSliceInstanceBlueFirstValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateFirstValue = true;
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Yellow;
                        setNineSliceInstanceGreenFirstValue = true;
                        NineSliceInstanceGreenFirstValue = 255;
                        setNineSliceInstanceRedFirstValue = true;
                        NineSliceInstanceRedFirstValue = 255;
                        setTextInstanceCurrentColorCategoryStateFirstValue = true;
                        TextInstanceCurrentColorCategoryStateFirstValue = AbbatoirIntergrade.GumRuntimes.TextRuntime.ColorCategory.Black;
                        break;
                    case  ComboBoxCategory.Pushed:
                        setNineSliceInstanceBlueFirstValue = true;
                ...
                switch(secondState)
                {
                    ...
                    case  ComboBoxCategory.Disabled:
                        ...
                        NineSliceInstanceBlueSecondValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateSecondValue = true;
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Black;
                        setNineSliceInstanceGreenSecondValue = true;
                        NineSliceInstanceGreenSecondValue = 255;
                        setNineSliceInstanceRedSecondValue = true;
                        NineSliceInstanceRedSecondValue = 255;
                    ...
                    case  ComboBoxCategory.Highlighted:
                        ...
                        NineSliceInstanceBlueSecondValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateSecondValue = true;
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime.ColorCategory.Yellow;
                        setNineSliceInstanceGreenSecondValue = true;
                        NineSliceInstanceGreenSecondValue = 255;
                        setNineSliceInstanceRedSecondValue = true;
                        NineSliceInstanceRedSecondValue = 255;
                        setTextInstanceCurrentColorCategoryStateSecondValue = true;
                        TextInstanceCurrentColorCategoryStateSecondValue = AbbatoirIntergrade.GumRuntimes.TextRuntime.ColorCategory.Black;
                        break;
                    case  ComboBoxCategory.Pushed:
                        setNineSliceInstanceBlueSecondValue = true;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.ComboBoxRuntime.VariableState fromState,AbbatoirIntergrade.GumRuntimes.ComboBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.ComboBoxRuntime.ComboBoxCategory fromState,AbbatoirIntergrade.GumRuntimes.ComboBoxRuntime.ComboBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private AbbatoirIntergrade.GumRuntimes.ListBoxRuntime ListBoxInstance { get; set; }
            private AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime NineSliceInstance { get; set; }
            ...
            {
                ListBoxInstance = this.GetGraphicalUiElementByName("ListBoxInstance") as AbbatoirIntergrade.GumRuntimes.ListBoxRuntime;
                NineSliceInstance = this.GetGraphicalUiElementByName("NineSliceInstance") as AbbatoirIntergrade.GumRuntimes.ColoredFrameRuntime;
