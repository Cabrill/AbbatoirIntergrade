    ...
    {
        public partial class WhiteFrameNineSliceRuntime : GBC2017.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            Middle.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                            ...
                            TopLeft.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                            ...
                            Top.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                            ...
                            TopRight.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                            ...
                            Right.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                            ...
                            BottomRight.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                            ...
                            Bottom.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                            ...
                            BottomLeft.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                            ...
                            Left.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue)
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        if (interpolationValue < 1)
                        {
                            this.Bottom.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("Bottom.SourceFile", "JustWindmill.png");
                        ...
                        if (interpolationValue < 1)
                        {
                            this.BottomLeft.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("BottomLeft.SourceFile", "JustWindmill.png");
                        ...
                        if (interpolationValue < 1)
                        {
                            this.BottomRight.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("BottomRight.SourceFile", "JustWindmill.png");
                        ...
                        if (interpolationValue < 1)
                        {
                            this.Left.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("Left.SourceFile", "JustWindmill.png");
                        ...
                        if (interpolationValue < 1)
                        {
                            this.Middle.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("Middle.SourceFile", "JustWindmill.png");
                        ...
                        if (interpolationValue < 1)
                        {
                            this.Right.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("Right.SourceFile", "JustWindmill.png");
                        ...
                        if (interpolationValue < 1)
                        {
                            this.Top.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("Top.SourceFile", "JustWindmill.png");
                        ...
                        if (interpolationValue < 1)
                        {
                            this.TopLeft.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("TopLeft.SourceFile", "JustWindmill.png");
                        ...
                        if (interpolationValue < 1)
                        {
                            this.TopRight.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "<SCREEN BOUNDS>");
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("TopRight.SourceFile", "JustWindmill.png");
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (GBC2017.GumRuntimes.WhiteFrameNineSliceRuntime.VariableState fromState,GBC2017.GumRuntimes.WhiteFrameNineSliceRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null)
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (GBC2017.GumRuntimes.WhiteFrameNineSliceRuntime.Connections fromState,GBC2017.GumRuntimes.WhiteFrameNineSliceRuntime.Connections toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null)
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private Gum.DataTypes.Variables.StateSave GetCurrentValuesOnState (VariableState state)
            {
                ...
                switch(state)
                {
                    case  VariableState.Default:
                        ...
                        {
                            SetsValue = true,
                            Name = "TopRight.Parent",
                            Type = "string",
                            Value = TopRight.Parent
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                        ...
                        {
                            SetsValue = true,
                            Name = "BottomRight.Parent",
                            Type = "string",
                            Value = BottomRight.Parent
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                        ...
                        {
                            SetsValue = true,
                            Name = "BottomLeft.Parent",
                            Type = "string",
                            Value = BottomLeft.Parent
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
            ...
            private GBC2017.GumRuntimes.SpriteRuntime Middle { get; set; }
            private GBC2017.GumRuntimes.SpriteRuntime TopLeft { get; set; }
            private GBC2017.GumRuntimes.SpriteRuntime Top { get; set; }
            private GBC2017.GumRuntimes.SpriteRuntime TopRight { get; set; }
            private GBC2017.GumRuntimes.SpriteRuntime Right { get; set; }
            private GBC2017.GumRuntimes.SpriteRuntime BottomRight { get; set; }
            private GBC2017.GumRuntimes.SpriteRuntime Bottom { get; set; }
            private GBC2017.GumRuntimes.SpriteRuntime BottomLeft { get; set; }
            private GBC2017.GumRuntimes.SpriteRuntime Left { get; set; }
            ...
            public WhiteFrameNineSliceRuntime (bool fullInstantiation = true)
            	: base(false)
            {
                this.HasEvents = true;
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "WhiteFrameNineSlice");
            ...
            {
                Middle = this.GetGraphicalUiElementByName("Middle") as GBC2017.GumRuntimes.SpriteRuntime;
                TopLeft = this.GetGraphicalUiElementByName("TopLeft") as GBC2017.GumRuntimes.SpriteRuntime;
                Top = this.GetGraphicalUiElementByName("Top") as GBC2017.GumRuntimes.SpriteRuntime;
                TopRight = this.GetGraphicalUiElementByName("TopRight") as GBC2017.GumRuntimes.SpriteRuntime;
                Right = this.GetGraphicalUiElementByName("Right") as GBC2017.GumRuntimes.SpriteRuntime;
                BottomRight = this.GetGraphicalUiElementByName("BottomRight") as GBC2017.GumRuntimes.SpriteRuntime;
                Bottom = this.GetGraphicalUiElementByName("Bottom") as GBC2017.GumRuntimes.SpriteRuntime;
                BottomLeft = this.GetGraphicalUiElementByName("BottomLeft") as GBC2017.GumRuntimes.SpriteRuntime;
                Left = this.GetGraphicalUiElementByName("Left") as GBC2017.GumRuntimes.SpriteRuntime;
            }
