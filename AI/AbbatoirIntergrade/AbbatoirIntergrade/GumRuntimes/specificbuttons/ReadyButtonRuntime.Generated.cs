    ...
    namespace AbbatoirIntergrade.GumRuntimes.specificbuttons
    {
        public partial class ReadyButtonRuntime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
            ...
            public PulseDisplay? CurrentPulseDisplayState
            {
                get
                {
                    return mCurrentPulseDisplayState;
                }
                set
                {
                    if (value != null)
            ...
            public void InterpolateBetween (ButtonCategory firstState, ButtonCategory secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    ...
                    case  ButtonCategory.Pushed:
                        setTextInstanceBlueFirstValue = true;
                        TextInstanceBlueFirstValue = 154;
                        setTextInstanceGreenFirstValue = true;
                        TextInstanceGreenFirstValue = 250;
                        setTextInstanceRedFirstValue = true;
                        TextInstanceRedFirstValue = 0;
                        break;
                }
                switch(secondState)
                {
                    ...
                    case  ButtonCategory.Pushed:
                        setTextInstanceBlueSecondValue = true;
                        TextInstanceBlueSecondValue = 154;
                        setTextInstanceGreenSecondValue = true;
                        TextInstanceGreenSecondValue = 250;
                        setTextInstanceRedSecondValue = true;
                        TextInstanceRedSecondValue = 0;
                        break;
                }
            ...
            public void InterpolateBetween (PulseDisplay firstState, PulseDisplay secondState, float interpolationValue) 
            {
                #if DEBUG
                if (float.IsNaN(interpolationValue))
                {
                ...
                switch(firstState)
                {
                    ...
                    case  PulseDisplay.PulseMid:
                        ...
                        TextInstanceBlueFirstValue = 255;
                        setTextInstanceFontScaleFirstValue = true;
                        TextInstanceFontScaleFirstValue = 1.05f;
                        setTextInstanceGreenFirstValue = true;
                        TextInstanceGreenFirstValue = 240;
                        setTextInstanceRedFirstValue = true;
                        TextInstanceRedFirstValue = 150;
                        setWidthFirstValue = true;
                        WidthFirstValue = 503f;
                        break;
                    case  PulseDisplay.PulseEnd:
                        setHeightFirstValue = true;
                        HeightFirstValue = 100f;
                        setTextInstanceFontScaleFirstValue = true;
                        TextInstanceFontScaleFirstValue = 1.2f;
                        setTextInstanceGreenFirstValue = true;
                        TextInstanceGreenFirstValue = 255;
                        setTextInstanceRedFirstValue = true;
                        TextInstanceRedFirstValue = 150;
                        setWidthFirstValue = true;
                        WidthFirstValue = 523f;
                        break;
                }
                switch(secondState)
                {
                    ...
                    case  PulseDisplay.PulseMid:
                        ...
                        TextInstanceBlueSecondValue = 255;
                        setTextInstanceFontScaleSecondValue = true;
                        TextInstanceFontScaleSecondValue = 1.05f;
                        setTextInstanceGreenSecondValue = true;
                        TextInstanceGreenSecondValue = 240;
                        setTextInstanceRedSecondValue = true;
                        TextInstanceRedSecondValue = 150;
                        setWidthSecondValue = true;
                        WidthSecondValue = 503f;
                        break;
                    case  PulseDisplay.PulseEnd:
                        setHeightSecondValue = true;
                        HeightSecondValue = 100f;
                        setTextInstanceFontScaleSecondValue = true;
                        TextInstanceFontScaleSecondValue = 1.2f;
                        setTextInstanceGreenSecondValue = true;
                        TextInstanceGreenSecondValue = 255;
                        setTextInstanceRedSecondValue = true;
                        TextInstanceRedSecondValue = 150;
                        setWidthSecondValue = true;
                        WidthSecondValue = 523f;
                        break;
                }
                if (setHeightFirstValue && setHeightSecondValue)
                {
                ...
                if (interpolationValue < 1)
                {
                    mCurrentPulseDisplayState = firstState;
                }
                else
                {
                    mCurrentPulseDisplayState = secondState;
                }
            }
            #endregion
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (PulseDisplay toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null ) 
            {
                Gum.DataTypes.Variables.StateSave current = GetCurrentValuesOnState(toState);
                Gum.DataTypes.Variables.StateSave toAsStateSave = this.ElementSave.Categories.First(item => item.Name == "PulseDisplay").States.First(item => item.Name == toState.ToString());
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: (float)secondsToTake, type: interpolationType, easing: easing);
                if (owner == null)
                {
                    tweener.Owner = this;
                ...
                tweener.PositionChanged = newPosition => this.InterpolateBetween(current, toAsStateSave, newPosition);
                tweener.Ended += ()=> this.CurrentPulseDisplayState = toState;
                tweener.Start();
                StateInterpolationPlugin.TweenerManager.Self.Add(tweener);
                return tweener;
            }
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateToRelative (PulseDisplay toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null ) 
            {
                Gum.DataTypes.Variables.StateSave current = GetCurrentValuesOnState(toState);
                Gum.DataTypes.Variables.StateSave toAsStateSave = AddToCurrentValuesWithState(toState);
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: (float)secondsToTake, type: interpolationType, easing: easing);
            ...
            {
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction( ()=> this.CurrentPulseDisplayState = PulseDisplay.PulseStart);
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime;
                    toReturn.Target = target;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(PulseDisplay.PulseMid, 1, FlatRedBall.Glue.StateInterpolation.InterpolationType.Linear, FlatRedBall.Glue.StateInterpolation.Easing.Out, PulseAnimation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 0;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(PulseDisplay.PulseEnd, 1, FlatRedBall.Glue.StateInterpolation.InterpolationType.Linear, FlatRedBall.Glue.StateInterpolation.Easing.Out, PulseAnimation));
                    toReturn.Target = target;
                ...
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(PulseDisplay.PulseStart, 1, FlatRedBall.Glue.StateInterpolation.InterpolationType.Linear, FlatRedBall.Glue.StateInterpolation.Easing.Out, PulseAnimation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 3;
                    yield return toReturn;
                }
                {
            ...
            private System.Collections.Generic.IEnumerable<FlatRedBall.Instructions.Instruction> PulseAnimationRelativeInstructions (object target) 
            {
                ...
                }
                {
                    ...
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "PulseDisplay/PulseStart").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "PulseDisplay/PulseMid").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(PulseDisplay.PulseMid);
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(() =>
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "PulseDisplay/PulseMid").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "PulseDisplay/PulseEnd").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(PulseDisplay.PulseEnd);
                        Gum.DataTypes.Variables.StateSave second = first.Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.AddIntoThis(second, difference);
                        FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: 1, type: FlatRedBall.Glue.StateInterpolation.InterpolationType.Linear, easing: FlatRedBall.Glue.StateInterpolation.Easing.Out);
                        tweener.Owner = this;
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(() =>
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "PulseDisplay/PulseEnd").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "PulseDisplay/PulseMid").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(PulseDisplay.PulseMid);
                ...
                }
                {
                    ...
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "PulseDisplay/PulseMid").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "PulseDisplay/PulseStart").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(PulseDisplay.PulseStart);
                        Gum.DataTypes.Variables.StateSave second = first.Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.AddIntoThis(second, difference);
                        FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: 1, type: FlatRedBall.Glue.StateInterpolation.InterpolationType.Linear, easing: FlatRedBall.Glue.StateInterpolation.Easing.Out);
                        tweener.Owner = this;
            ...
            public FlatRedBall.Gum.Animation.GumAnimation PulseAnimation
            {
                get
                {
                    ...
                    {
                        pulseAnimation = new FlatRedBall.Gum.Animation.GumAnimation(4, PulseAnimationInstructions);
                    }
            ...
            public FlatRedBall.Gum.Animation.GumAnimation PulseAnimationRelative
            {
                get
                {
                    ...
                    {
                        pulseAnimationRelative = new FlatRedBall.Gum.Animation.GumAnimation(4, PulseAnimationRelativeInstructions);
                    }
            ...
            private Gum.DataTypes.Variables.StateSave GetCurrentValuesOnState (PulseDisplay state) 
            {
                Gum.DataTypes.Variables.StateSave newState = new Gum.DataTypes.Variables.StateSave();
                switch(state)
                {
            ...
            private Gum.DataTypes.Variables.StateSave AddToCurrentValuesWithState (PulseDisplay state) 
            {
                Gum.DataTypes.Variables.StateSave newState = new Gum.DataTypes.Variables.StateSave();
                switch(state)
                {
                    ...
                    case  PulseDisplay.PulseMid:
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "TextInstance.Font Scale",
                            Type = "float",
                            Value = TextInstance.FontScale + 1.05f
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                    ...
                    case  PulseDisplay.PulseEnd:
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "TextInstance.Font Scale",
                            Type = "float",
                            Value = TextInstance.FontScale + 1.2f
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
            ...
            public override void ApplyState (Gum.DataTypes.Variables.StateSave state) 
            {
                ...
                if (matches)
                {
                    ...
                    else if (category.Name == "PulseDisplay")
                    {
                        if(state.Name == "PulseStart") this.mCurrentPulseDisplayState = PulseDisplay.PulseStart;
                        if(state.Name == "PulseMid") this.mCurrentPulseDisplayState = PulseDisplay.PulseMid;
                        if(state.Name == "PulseEnd") this.mCurrentPulseDisplayState = PulseDisplay.PulseEnd;
                    }
                }
            ...
            public int ReadyTextBlue
            {
                ...
                set
                {
                    if (TextInstance.Blue != value)
                    {
                        ...
                        ReadyTextBlueChanged?.Invoke(this, null);
                    }
                }
            }
            public float ReadyTextScale
            {
                get
                {
                ...
                set
                {
                    if (TextInstance.FontScale != value)
                    {
                        ...
                        ReadyTextScaleChanged?.Invoke(this, null);
                    }
                }
            }
            public int ReadyTextGreen
            {
                get
                {
                ...
                set
                {
                    if (TextInstance.Green != value)
                    {
                        ...
                        ReadyTextGreenChanged?.Invoke(this, null);
                    }
                }
            }
            public int ReadyTextRed
            {
                get
                {
                ...
                set
                {
                    if (TextInstance.Red != value)
                    {
                        ...
                        ReadyTextRedChanged?.Invoke(this, null);
                    }
                }
            }
            public event System.EventHandler ReadyTextBlueChanged;
            public event System.EventHandler ReadyTextScaleChanged;
            public event System.EventHandler ReadyTextGreenChanged;
            public event System.EventHandler ReadyTextRedChanged;
            public ReadyButtonRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
            	: base(false, tryCreateFormsObject)
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "specificbuttons/ReadyButton");
