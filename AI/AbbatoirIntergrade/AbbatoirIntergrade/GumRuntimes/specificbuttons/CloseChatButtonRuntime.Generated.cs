    ...
    namespace AbbatoirIntergrade.GumRuntimes.specificbuttons
    {
        public partial class CloseChatButtonRuntime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            SpriteInstance.TextureLeft = 3584;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        SpriteInstanceTextureLeftFirstValue = 3584;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        SpriteInstanceTextureLeftSecondValue = 3584;
            ...
            public void InterpolateBetween (Highlight firstState, Highlight secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  Highlight.Highlighted:
                        ...
                        SpriteInstanceBlueFirstValue = 0;
                        setSpriteInstanceGreenFirstValue = true;
                        SpriteInstanceGreenFirstValue = 69;
                        setSpriteInstanceRedFirstValue = true;
                        SpriteInstanceRedFirstValue = 255;
                        break;
                    case  Highlight.NotHighlighted:
                ...
                switch(secondState)
                {
                    case  Highlight.Highlighted:
                        ...
                        SpriteInstanceBlueSecondValue = 0;
                        setSpriteInstanceGreenSecondValue = true;
                        SpriteInstanceGreenSecondValue = 69;
                        setSpriteInstanceRedSecondValue = true;
                        SpriteInstanceRedSecondValue = 255;
                        break;
                    case  Highlight.NotHighlighted:
                ...
                switch(state)
                {
                    case  VariableState.Default:
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "SpriteInstance.Texture Left",
                            Type = "int",
                            Value = SpriteInstance.TextureLeft + 3584
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
            	...
            	: base(false, tryCreateFormsObject)
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "specificbuttons/CloseChatButton");
