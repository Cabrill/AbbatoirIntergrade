    ...
    namespace AbbatoirIntergrade.GumRuntimes
    {
        public partial class MenuFrameRuntime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.MenuFrameRuntime.VariableState fromState,AbbatoirIntergrade.GumRuntimes.MenuFrameRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public MenuFrameRuntime (bool fullInstantiation = true) 
            	: base(false)
            {
