    ...
    {
        public partial class LargeInfoFrameRuntime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            BackgroundSprite.TextureHeight = 1545;
                            BackgroundSprite.TextureLeft = 512;
                            BackgroundSprite.TextureTop = 1152;
                            BackgroundSprite.TextureWidth = 2018;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundSpriteTextureHeightFirstValue = 1545;
                        ...
                        BackgroundSpriteTextureWidthFirstValue = 2018;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundSpriteTextureHeightSecondValue = 1545;
                        ...
                        BackgroundSpriteTextureWidthSecondValue = 2018;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.LargeInfoFrameRuntime.VariableState fromState,AbbatoirIntergrade.GumRuntimes.LargeInfoFrameRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                ...
                switch(state)
                {
                    case  VariableState.Default:
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "BackgroundSprite.Texture Height",
                            Type = "int",
                            Value = BackgroundSprite.TextureHeight + 1545
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "BackgroundSprite.Texture Width",
                            Type = "int",
                            Value = BackgroundSprite.TextureWidth + 2018
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
