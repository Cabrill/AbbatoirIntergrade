                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            CircleInstance.XUnits = Gum.Converters.GeneralUnitType.PixelsFromMiddle;
                            CircleInstance.YOrigin = RenderingLibrary.Graphics.VerticalAlignment.Center;
                            CircleInstance.YUnits = Gum.Converters.GeneralUnitType.PixelsFromMiddle;
                            break;
                    }
                }
            }
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        if (interpolationValue < 1)
                        {
                            this.CircleInstance.XUnits = Gum.Converters.GeneralUnitType.PixelsFromMiddle;
                        }
                        if (interpolationValue < 1)
                        {
                        ...
                        if (interpolationValue < 1)
                        {
                            this.CircleInstance.YUnits = Gum.Converters.GeneralUnitType.PixelsFromMiddle;
                        }
