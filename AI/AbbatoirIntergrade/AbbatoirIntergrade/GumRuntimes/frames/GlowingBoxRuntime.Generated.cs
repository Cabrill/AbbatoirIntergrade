    ...
    {
        public partial class GlowingBoxRuntime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        BottomLeftHeightFirstValue = 64f;
                        if (interpolationValue < 1)
                        {
                        ...
                        BottomRightHeightFirstValue = 64f;
                        if (interpolationValue < 1)
                        {
                        ...
                        BottomRightWidthFirstValue = 64f;
                        if (interpolationValue < 1)
                        {
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        BottomLeftHeightSecondValue = 64f;
                        if (interpolationValue >= 1)
                        {
                            this.BottomLeft.HeightUnits = Gum.DataTypes.DimensionUnitType.Absolute;
                        }
                        ...
                        BottomLeftWidthSecondValue = 64f;
                        if (interpolationValue >= 1)
                        {
                            this.BottomLeft.WidthUnits = Gum.DataTypes.DimensionUnitType.Absolute;
                        }
                        ...
                        BottomRightHeightSecondValue = 64f;
                        if (interpolationValue >= 1)
                        {
                            this.BottomRight.HeightUnits = Gum.DataTypes.DimensionUnitType.Absolute;
                        }
                        ...
                        BottomRightWidthSecondValue = 64f;
                        if (interpolationValue >= 1)
                        {
                            this.BottomRight.WidthUnits = Gum.DataTypes.DimensionUnitType.Absolute;
                        }
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.Frames.GlowingBoxRuntime.VariableState fromState,AbbatoirIntergrade.GumRuntimes.Frames.GlowingBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.Frames.GlowingBoxRuntime.FlickerState fromState,AbbatoirIntergrade.GumRuntimes.Frames.GlowingBoxRuntime.FlickerState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (AbbatoirIntergrade.GumRuntimes.Frames.GlowingBoxRuntime.ColorState fromState,AbbatoirIntergrade.GumRuntimes.Frames.GlowingBoxRuntime.ColorState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private System.Collections.Generic.IEnumerable<FlatRedBall.Instructions.Instruction> Flicker2AnimationInstructions (object target) 
            {
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction( ()=> this.CurrentFlickerStateState = FlickerState.Flicker1);
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime;
                    toReturn.Target = target;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker2, 0.1f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 0;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker3, 0.1f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 0.1f;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker4, 0.1f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 0.2f;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker5, 0.09999999f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 0.3f;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker6, 0.09999999f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 0.4f;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker7, 0.1f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 0.5f;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker8, 0.09999996f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 0.6f;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker9, 0.1f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 0.7f;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker8, 0.09999996f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                ...
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker6, 0.1f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 1;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker5, 0.1f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 1.1f;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker4, 0.0999999f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 1.2f;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker3, 0.1f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => this.InterpolateTo(FlickerState.Flicker2, 0.1f, FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, FlatRedBall.Glue.StateInterpolation.Easing.Out, Flicker2Animation));
                    toReturn.Target = target;
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 1.4f;
                    yield return toReturn;
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => FlatRedBall.Instructions.InstructionManager.Instructions.AddRange(this.Flicker2AnimationInstructions(target)));
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 1.5f;
                    toReturn.Target = target;
                    yield return toReturn;
                }
            }
            private System.Collections.Generic.IEnumerable<FlatRedBall.Instructions.Instruction> Flicker2AnimationRelativeInstructions (object target) 
            {
                {
                }
                {
                    ...
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker1").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker2").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(FlickerState.Flicker2);
                        ...
                        FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: 0.1f, type: FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, easing: FlatRedBall.Glue.StateInterpolation.Easing.Out);
                        tweener.Owner = this;
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(() =>
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker2").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker3").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(FlickerState.Flicker3);
                        Gum.DataTypes.Variables.StateSave second = first.Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.AddIntoThis(second, difference);
                        FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: 0.1f, type: FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, easing: FlatRedBall.Glue.StateInterpolation.Easing.Out);
                        tweener.Owner = this;
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(() =>
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker3").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker4").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(FlickerState.Flicker4);
                        Gum.DataTypes.Variables.StateSave second = first.Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.AddIntoThis(second, difference);
                        FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: 0.1f, type: FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, easing: FlatRedBall.Glue.StateInterpolation.Easing.Out);
                        tweener.Owner = this;
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(() =>
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker4").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker5").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(FlickerState.Flicker5);
                        Gum.DataTypes.Variables.StateSave second = first.Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.AddIntoThis(second, difference);
                        FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: 0.09999999f, type: FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, easing: FlatRedBall.Glue.StateInterpolation.Easing.Out);
                        tweener.Owner = this;
                        tweener.PositionChanged = newPosition => this.InterpolateBetween(first, second, newPosition);
                        tweener.Start();
                        StateInterpolationPlugin.TweenerManager.Self.Add(tweener);
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(() =>
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker5").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker6").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(FlickerState.Flicker6);
                        Gum.DataTypes.Variables.StateSave second = first.Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.AddIntoThis(second, difference);
                        FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: 0.09999999f, type: FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, easing: FlatRedBall.Glue.StateInterpolation.Easing.Out);
                        tweener.Owner = this;
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(() =>
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker6").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker7").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(FlickerState.Flicker7);
                        Gum.DataTypes.Variables.StateSave second = first.Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.AddIntoThis(second, difference);
                        FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: 0.1f, type: FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, easing: FlatRedBall.Glue.StateInterpolation.Easing.Out);
                        tweener.Owner = this;
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(() =>
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker7").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker8").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(FlickerState.Flicker8);
                        Gum.DataTypes.Variables.StateSave second = first.Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.AddIntoThis(second, difference);
                        FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: 0.09999996f, type: FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, easing: FlatRedBall.Glue.StateInterpolation.Easing.Out);
                        tweener.Owner = this;
                        tweener.PositionChanged = newPosition => this.InterpolateBetween(first, second, newPosition);
                        tweener.Start();
                        StateInterpolationPlugin.TweenerManager.Self.Add(tweener);
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(() =>
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker8").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker9").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(FlickerState.Flicker9);
                        Gum.DataTypes.Variables.StateSave second = first.Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.AddIntoThis(second, difference);
                        FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: 0.1f, type: FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, easing: FlatRedBall.Glue.StateInterpolation.Easing.Out);
                        tweener.Owner = this;
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(() =>
                    {
                        var relativeStart = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker9").Clone();
                        var relativeEnd = ElementSave.AllStates.FirstOrDefault(item => item.Name == "FlickerState/Flicker8").Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.SubtractFromThis(relativeEnd, relativeStart);
                        var difference = relativeEnd;
                        Gum.DataTypes.Variables.StateSave first = GetCurrentValuesOnState(FlickerState.Flicker8);
                ...
                }
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(() =>
                    {
                        ...
                        Gum.DataTypes.Variables.StateSave second = first.Clone();
                        Gum.DataTypes.Variables.StateSaveExtensionMethods.AddIntoThis(second, difference);
                        FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from: 0, to: 1, duration: 0.0999999f, type: FlatRedBall.Glue.StateInterpolation.InterpolationType.Instant, easing: FlatRedBall.Glue.StateInterpolation.Easing.Out);
                        tweener.Owner = this;
                        tweener.PositionChanged = newPosition => this.InterpolateBetween(first, second, newPosition);
                        tweener.Start();
                        StateInterpolationPlugin.TweenerManager.Self.Add(tweener);
                ...
                {
                    var toReturn = new FlatRedBall.Instructions.DelegateInstruction(  () => FlatRedBall.Instructions.InstructionManager.Instructions.AddRange(this.Flicker2AnimationRelativeInstructions(target)));
                    toReturn.TimeToExecute = FlatRedBall.TimeManager.CurrentTime + 1.5f;
                    toReturn.Target = target;
                    yield return toReturn;
                }
            }
            private FlatRedBall.Gum.Animation.GumAnimation flicker2Animation;
            public FlatRedBall.Gum.Animation.GumAnimation Flicker2Animation
            {
                get
                {
                    if (flicker2Animation == null)
                    {
                        flicker2Animation = new FlatRedBall.Gum.Animation.GumAnimation(1.5f, Flicker2AnimationInstructions);
                    }
                    return flicker2Animation;
                }
            }
            private FlatRedBall.Gum.Animation.GumAnimation flicker2AnimationRelative;
            public FlatRedBall.Gum.Animation.GumAnimation Flicker2AnimationRelative
            {
                get
                {
                    if (flicker2AnimationRelative == null)
                    {
                        flicker2AnimationRelative = new FlatRedBall.Gum.Animation.GumAnimation(1.5f, Flicker2AnimationRelativeInstructions);
                    }
                    return flicker2AnimationRelative;
                }
            }
            #endregion
            	...
            	: base(false, tryCreateFormsObject)
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "Frames/GlowingBox");
