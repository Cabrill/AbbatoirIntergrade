    ...
    namespace AbbatoirIntergrade.GumRuntimes
    {
        public partial class ChatFrameRuntime : AbbatoirIntergrade.GumRuntimes.ContainerRuntime
        {
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            BackgroundSprite.TextureHeight = 825;
                            BackgroundSprite.TextureLeft = 512;
                            BackgroundSprite.TextureTop = 2720;
                            BackgroundSprite.TextureWidth = 2008;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundSpriteTextureHeightFirstValue = 825;
                        ...
                        BackgroundSpriteTextureTopFirstValue = 2720;
                        setBackgroundSpriteTextureWidthFirstValue = true;
                        BackgroundSpriteTextureWidthFirstValue = 2008;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundSpriteTextureHeightSecondValue = 825;
                        ...
                        BackgroundSpriteTextureTopSecondValue = 2720;
                        setBackgroundSpriteTextureWidthSecondValue = true;
                        BackgroundSpriteTextureWidthSecondValue = 2008;
                ...
                switch(state)
                {
                    case  VariableState.Default:
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "BackgroundSprite.Texture Height",
                            Type = "int",
                            Value = BackgroundSprite.TextureHeight + 825
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "BackgroundSprite.Texture Top",
                            Type = "int",
                            Value = BackgroundSprite.TextureTop + 2720
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "BackgroundSprite.Texture Width",
                            Type = "int",
                            Value = BackgroundSprite.TextureWidth + 2008
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
            	...
            	: base(false)
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "frames/ChatFrame");
